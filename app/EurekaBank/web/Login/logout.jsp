...
<head>
	<meta charset="utf-8">
	<title>Ingreso - EurekaBank</title>
	
	<!-- Stylesheets -->
        <link rel="stylesheet" type="text/css" href="/EurekaBank/faces/resources/css/styleLogin.css" />
...
<body>
	...
	<div id="header">
		...
		<div class="page-full-width cf">
			...
			<a href="#" id="company-branding" class="fr"><img src="/EurekaBank/faces/resources/images/company-logo.png" alt="Blue Hosting" /></a>
